    ...
    <div>
      <main className="">
        <div className="mx-auto max-w-full">
          <div className="overflow-hidden px-4 pt-5 pb-8 text-gray-900 bg-white rounded-md">
            <div className="divide-y divide-gray-200 lg:divide-x lg:divide-y-0">
              ...
              >
                    ...
                    <ul role="list" className="mt-2 divide-y divide-gray-200">
                      <div className="grid grid-cols-2 gap-x-4">
                        <div className="p-4 mb-6 space-y-4">
                          <Field
                            as="li"
                            className="flex justify-between items-center p-4 rounded-md border border-gray-300 shadow-md duration-75 ease-in-out bg-white/50 hover:scale-105"
                          >
                            ...
                            <Switch
                              checked={level}
                              onChange={setLevel}
                              className="group relative ml-4 inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent bg-gray-800 transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-sky-300 focus:ring-offset-2 data-[checked]:bg-teal-500"
                            >
                              <span
                                aria-hidden="true"
                ...
                <div className="pt-6 divide-y divide-gray-200">
                  <div className="flex gap-4 justify-end px-4 sm:px-6">
                    <button
                      type="submit"
                      className="inline-flex justify-center px-6 py-2 text-base font-semibold text-white bg-sky-700 rounded-md shadow-sm hover:bg-sky-600 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-sky-700"
                    >
                      Save
                    </button>
                    <button
                      type="button"
                      className="inline-flex justify-center px-6 py-2 text-base font-semibold text-white bg-red-600 rounded-md ring-1 ring-inset ring-gray-300 shadow-sm hover:bg-red-700"
                    >
                      Cancel
                    </button>
